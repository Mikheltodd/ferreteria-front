  ...
  <div id="app" class="app">
    <div class="header">
      ...
      <nav>
        ...
        <button v-on:click="account" v-if="is_auth">Productos</button>
        <button v-on:click="transacction" v-if="is_auth">Transacciones</button>
        <button v-on:click="historial" v-if="is_auth">Eliminar</button>
